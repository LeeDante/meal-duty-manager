...
CREATE TABLE IF NOT EXISTS stores(id TEXT PRIMARY KEY,name TEXT NOT NULL,phone TEXT NOT NULL DEFAULT '',sort_order INTEGER NOT NULL DEFAULT 0,active INTEGER NOT NULL DEFAULT 1);
CREATE TABLE IF NOT EXISTS menu_items(id TEXT PRIMARY KEY,store_id TEXT NOT NULL,name TEXT NOT NULL,price INTEGER NOT NULL DEFAULT 0,spice_required INTEGER NOT NULL DEFAULT 0,sort_order INTEGER NOT NULL DEFAULT 0,active INTEGER NOT NULL DEFAULT 1,FOREIGN KEY(store_id) REFERENCES stores(id));
...
CREATE TABLE IF NOT EXISTS meal_menu_items(id TEXT PRIMARY KEY,meal_id TEXT NOT NULL,source_id TEXT,store_id TEXT,name TEXT NOT NULL,price INTEGER NOT NULL DEFAULT 0,spice_required INTEGER NOT NULL DEFAULT 0,special INTEGER NOT NULL DEFAULT 0,sort_order INTEGER NOT NULL DEFAULT 0,active INTEGER NOT NULL DEFAULT 1,FOREIGN KEY(meal_id) REFERENCES meals(id));
CREATE TABLE IF NOT EXISTS orders(id TEXT PRIMARY KEY,meal_id TEXT NOT NULL,event_id TEXT NOT NULL,person_id TEXT NOT NULL,meal_menu_id TEXT NOT NULL,name TEXT NOT NULL,price INTEGER NOT NULL DEFAULT 0,qty INTEGER NOT NULL DEFAULT 1,spice_level TEXT NOT NULL DEFAULT '',note TEXT NOT NULL DEFAULT '',active INTEGER NOT NULL DEFAULT 1,updated_at TEXT NOT NULL,FOREIGN KEY(meal_id) REFERENCES meals(id),FOREIGN KEY(person_id) REFERENCES people(id));
...
CREATE TABLE IF NOT EXISTS pin_attempts(attempt_key TEXT PRIMARY KEY,failures INTEGER NOT NULL DEFAULT 0,window_started_at INTEGER NOT NULL,locked_until INTEGER NOT NULL DEFAULT 0);
